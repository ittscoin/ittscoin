...
const string strMessageMagic = "ITTScoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.5 * 24 * 60 * 60; // ITTScoin: 0.5 days
static const int64 nTargetSpacing = 60; // ITTScoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ittscoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ITTScoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1c2159904f47ae43c7fb4a90185f73d94fa7acd5ba7a30ee54440a2c02ff8a70");
    }
	...
	//  nTime=1434914370, nBits=1e0ffff0, nNonce=2085386442, vtx=1)
	...
	// vMerkleTree: 5a2e19825b
        ...
        block.nVersion = 1;
        block.nTime    = 1435683246;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 407531772;

        if (fTestNet)
        {
            block.nTime    = 1434914370;
            block.nNonce   = 387144609;
        }
